...
public class IsomorphismChecker {
	...
	public boolean isIsomorphic(Graph a, Graph b)
	{
		...
		//since the problem statement states there could only one possible root. the algorithms doesnt try to find other roots.
	...
	{
		// since vertex cant be null at this point below condition is to handle root vertex being null for any of the graph
//		if(a == null && b == null) return true;
		...
		{
			System.out.println(g2.adjMap.get(b));
			
//			System.out.println(g1.adjMap.get(a));
